...
if (UNIX AND NOT APPLE)
    ...
    string(REPLACE ":" "-" NXDN_DEB_VERSION_FILENAME "${NXDN_DEB_VERSION}")
    message("DEB Version: ${NXDN_DEB_VERSION}")

    set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-${NXDN_DEB_VERSION_FILENAME}-${CPACK_DEBIAN_PACKAGE_ARCHITECTURE}")
